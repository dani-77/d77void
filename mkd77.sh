...
usage() {
	...
	OPTIONS
	 ...
	 --musl        Build for musl libc (x86_64-musl paths, firefox instead of brave-bin)
	 --nc          No calamares: use d77void-installer instead
...
# Architecture-dependent globals (set once, used by include_* functions)
if [ -n "$MUSL" ]; then
	ARCH_PATH="x86_64-musl"
	BROWSER="firefox"
	PLASMA_BROWSER="firefox"
	REPO_PKGS="void-repo-nonfree"
else
	ARCH_PATH="x86_64"
	BROWSER="brave-bin"
	PLASMA_BROWSER="librewolf-bin"
	REPO_PKGS="void-repo-multilib void-repo-multilib-nonfree void-repo-nonfree"
fi
...
include_greetd() {
	...
	cp -r ./common/quickshell-d77/greeter/. "$INCLUDEDIR"/etc/greetd/quickshell-d77/greeter/
	cp ./common/quickshell-d77/greeter/assets/greet-dwl.sh "$INCLUDEDIR"/etc/greetd/
	cp ./common/quickshell-d77/greeter/config.toml "$INCLUDEDIR"/etc/greetd/
...
include_plymouth() {
	...
	mkdir -p "$INCLUDEDIR"/etc/plymouth
	mkdir -p "$INCLUDEDIR"/usr/share/plymouth/themes
	cp ./common/10-plymouth.conf "$INCLUDEDIR"/etc/dracut.conf.d/
	cp ./common/99-plymouth-dracut "$INCLUDEDIR"/etc/kernel.d/post-install/
	cp ./common/plymouthd.conf "$INCLUDEDIR"/etc/plymouth/
...
_include_base() {
	...
	if [ "$variant" != cosmic ]; then
		# cosmic has no ALSA "pulse" plugin (alsa-plugins-pulseaudio) installed, so
		# forcing pcm/ctl !default to "type pulse" here would break ALSA output;
		# alsa-pipewire's own conf.d symlinks already route ALSA to pipewire directly.
...
include_rofi() {
	PKGS="$PKGS oranchelo-icon-theme rofi"
	mkdir -p "$INCLUDEDIR"/etc/skel/.config
	mkdir -p "$INCLUDEDIR"/usr/bin
...
build_variant() {
	...
	case "$ARCH" in
		x86_64*|i686*)
			...
			TARGET_ARCH="$ARCH"
			if [ -n "$MUSL" ]; then
				D77_CORE="acpi apulse alsa-plugins-pulseaudio alsa-tools alsa-utils arc-theme bash-completion bc firefox brightnessctl ca-certificates cmus cups cups-browsed curl elogind ethtool fastfetch feh font-awesome font-awesome5 font-awesome6 font-hack-ttf geary gettext git d77run htop inxi kvantum mousepad mpv musl-locales nano NetworkManager nerd-fonts-symbols-ttf nwg-look octoxbps papirus-icon-theme pcmanfm plymouth polkit power-profiles-daemon qt5ct qt6ct qt5-graphicaleffects ranger smartmontools system-config-printer transmission-qt udiskie ufw uget unzip usbutils util-linux vim wget xdg-user-dirs xdg-user-dirs-gtk xdg-utils xf86-input-synaptics xarchiver xcalc xinit xorg xorg-server xpdf yt-dlp zathura zathura-pdf-poppler"
				D77_COSMIC="acpi alsa-pipewire alsa-tools alsa-utils arc-theme bash-completion bc brightnessctl ca-certificates cmus cups cups-browsed curl elogind ethtool feh ffmpeg font-hack-ttf geary gettext git htop inxi kvantum musl-locales nano NetworkManager neofetch nerd-fonts-symbols-ttf octoxbps papirus-icon-theme pipewire plymouth polkit power-profiles-daemon pulseaudio-utils qt5ct qt6ct ranger smartmontools transmission-qt udiskie ufw uget unzip usbutils util-linux vim $REPO_PKGS wget wireplumber xdg-user-dirs xdg-user-dirs-gtk xdg-utils xf86-input-synaptics xinit xorg xorg-server xpdf yt-dlp zathura zathura-pdf-poppler"
				D77_GNOME="acpi apulse alsa-pipewire alsa-plugins-pulseaudio alsa-tools alsa-utils arc-theme bash-completion bc brightnessctl ca-certificates cmus cups cups-browsed curl elogind ethtool feh ffmpeg font-hack-ttf geary gettext git htop inxi kvantum musl-locales nano NetworkManager neofetch nerd-fonts-symbols-ttf octoxbps papirus-icon-theme pipewire plymouth polkit power-profiles-daemon qt5ct qt6ct ranger smartmontools transmission-qt udiskie ufw uget unzip usbutils util-linux vim $REPO_PKGS wget wireplumber xdg-user-dirs xdg-user-dirs-gtk xdg-utils xf86-input-synaptics xinit xorg xorg-server xpdf yt-dlp zathura zathura-pdf-poppler"
				D77_WAYFIRE="acpi apulse alsa-plugins-pulseaudio alsa-tools alsa-utils arc-theme bash-completion bc firefox brightnessctl ca-certificates cmus cups cups-browsed curl dunst elogind ethtool fastfetch feh font-awesome font-awesome5 font-awesome6 font-awesome7 font-hack-ttf geary gettext git d77run htop inxi kitty kvantum mousepad mpv musl-locales nano NetworkManager nerd-fonts-symbols-ttf nwg-look octoxbps papirus-icon-theme pcmanfm plymouth polkit power-profiles-daemon qt5ct qt6ct qt5-graphicaleffects ranger smartmontools system-config-printer transmission-gtk udiskie ufw uget unzip usbutils util-linux vim $REPO_PKGS wget xdg-desktop-portal xdg-user-dirs xdg-user-dirs-gtk xdg-utils xf86-input-synaptics xarchiver xcalc xinit xorg xorg-server xpdf xterm yt-dlp zathura zathura-pdf-poppler"
			else
				D77_CORE="acpi apulse alsa-plugins-pulseaudio alsa-tools alsa-utils arc-theme bash-completion bc brave-bin brightnessctl ca-certificates cmus cups cups-browsed curl elogind ethtool fastfetch feh font-awesome font-awesome5 font-awesome6 font-awesome7 font-hack-ttf geary gettext git d77run htop inxi kvantum mousepad mpv nano NetworkManager nerd-fonts-symbols-ttf nwg-look octoxbps papirus-icon-theme pcmanfm plymouth polkit power-profiles-daemon qt5ct qt6ct qt5-graphicaleffects ranger smartmontools system-config-printer transmission-qt udiskie ufw uget unzip usbutils util-linux vim $REPO_PKGS wget xdg-user-dirs xdg-user-dirs-gtk xdg-utils xf86-input-synaptics xarchiver xcalc xinit xorg xorg-server xpdf yt-dlp zathura zathura-pdf-poppler"
				D77_COSMIC="acpi alsa-pipewire alsa-tools alsa-utils arc-theme bash-completion bc brightnessctl ca-certificates cmus cups cups-browsed curl elogind ethtool feh ffmpeg font-hack-ttf geary gettext git htop inxi kvantum nano NetworkManager neofetch nerd-fonts-symbols-ttf octoxbps papirus-icon-theme pipewire plymouth polkit power-profiles-daemon pulseaudio-utils qt5ct qt6ct ranger smartmontools transmission-qt udiskie ufw uget unzip usbutils util-linux vim $REPO_PKGS wget wireplumber xdg-user-dirs xdg-user-dirs-gtk xdg-utils xf86-input-synaptics xinit xorg xorg-server xpdf yt-dlp zathura zathura-pdf-poppler"
	...
	PKGS="dialog cryptsetup lvm2 mdadm void-docs-browse xtools-minimal xmirror chrony tmux gvfs $A11Y_PKGS $GRUB_PKGS"
	...
	case $variant in
		...
		labwc)
			...
			WAY=yes
			FUZZEL=yes
			PKGS="$PKGS $XORG_PKGS $WAYLAND_PKGS $D77_CORE $CALAMARES grim ImageMagick kitty labwc labwc-menu-generator labwc-tweaks-qt mate-polkit qt5-wayland qt6-wayland swaybg swayidle swayimg swaylock xdg-desktop-portal-gtk xdg-desktop-portal-wlr"
			SERVICES="$SERVICES cupsd cups-browsed dbus NetworkManager polkitd power-profiles-daemon"
		;;
		leftwm)
			COMMON=yes
		...
		pwm)
			...
			X11=yes
			SDDM=yes
			PKGS="$PKGS $XORG_PKGS $CALAMARES acpi apulse alsa-plugins-pulseaudio alsa-tools alsa-utils arc-theme bash-completion bc brightnessctl ca-certificates cmus conky cups cups-browsed curl dmenu elogind ethtool feh font-hack-ttf fresh-editor gettext git d77run htop inxi joshuto kvantum mate-polkit mpv neofetch nerd-fonts-symbols-ttf NetworkManager nwg-look octoxbps papirus-icon-theme pcmanfm plymouth polkit power-profiles-daemon pwm qt5ct qt6ct qt5-graphicaleffects qutebrowser rofi smartmontools sxhkd system-config-printer transmission-qt udiskie ufw uget unzip usbutils util-linux vim $REPO_PKGS wget xdg-desktop-portal-gtk xdg-user-dirs xdg-user-dirs-gtk xdg-utils xf86-input-synaptics xarchiver xcalc xinit xorg xorg-server xpdf yt-dlp zathura zathura-pdf-poppler"
			SERVICES="$SERVICES cupsd cups-browsed dbus NetworkManager polkitd power-profiles-daemon"
		;;
		qsd77)
			COMMON=yes
		...
		river)
			...
			WAY=yes
			FUZZEL=yes
			PKGS="$PKGS $XORG_PKGS $WAYLAND_PKGS $D77_CORE $CALAMARES grim ImageMagick kitty mate-polkit qt5-wayland qt6-wayland river river-bedload river-shifttags swaybg swayidle swayimg swaylock xdg-desktop-portal-gtk xdg-desktop-portal-wlr"
			SERVICES="$SERVICES cupsd cups-browsed dbus NetworkManager polkitd power-profiles-daemon"
		;;
		scroll)
			COMMON=yes
		...
		wayfire)
			COMMON=yes
			GREETD=yes
			PKGS="$PKGS $XORG_PKGS $WAYLAND_PKGS $D77_WAYFIRE $CALAMARES cliphist grim ImageMagick mate-polkit pavucontrol qt5-wayland qt6-wayland swaybg swayidle swayimg swaylock wayfire wayfire-plugins-extra wcm wf-shell wlr-randr wlogout xdg-desktop-portal-wlr"
			SERVICES="$SERVICES cupsd cups-browsed dbus NetworkManager polkitd power-profiles-daemon"
		;;
		wmd77)
			COMMON=yes
			X11=yes
			SDDM=yes
			PKGS="$PKGS $XORG_PKGS $CALAMARES acpi apulse alsa-plugins-pulseaudio alsa-tools alsa-utils arc-theme bash-completion bc brightnessctl ca-certificates cmus conky cups cups-browsed curl dmenu elogind ethtool feh font-hack-ttf fresh-editor gettext git d77run htop inxi joshuto kvantum mate-polkit mpv neofetch nerd-fonts-symbols-ttf NetworkManager nwg-look octoxbps papirus-icon-theme pcmanfm plymouth polkit power-profiles-daemon qt5ct qt6ct qt5-graphicaleffects qutebrowser rofi smartmontools sxhkd system-config-printer transmission-qt udiskie ufw uget unzip usbutils util-linux vim $REPO_PKGS wget wmd77 xdg-desktop-portal-gtk xdg-user-dirs xdg-user-dirs-gtk xdg-utils xf86-input-synaptics xarchiver xcalc xinit xorg xorg-server xpdf yt-dlp zathura zathura-pdf-poppler"
			SERVICES="$SERVICES cupsd cups-browsed dbus NetworkManager polkitd power-profiles-daemon"
		;;
		xfce)
			XFCE=yes
			PKGS="$PKGS $XORG_PKGS $CALAMARES acpi apulse alsa-plugins-pulseaudio alsa-tools alsa-utils arc-theme bash-completion bc $BROWSER brightnessctl ca-certificates cmus cups cups-browsed curl dunst elogind epson-inkjet-printer-escpr ethtool fastfetch feh font-awesome font-awesome5 font-awesome6 font-hack-ttf geary gettext git github-cli gvfs-afc gvfs-mtp gvfs-smb htop inxi kvantum mpv mugshot nano NetworkManager network-manager-applet nerd-fonts-symbols-ttf octoxbps papirus-icon-theme plymouth polkit power-profiles-daemon qt5-graphicaleffects qt5ct qt6ct ranger redshift redshift-gtk sddm scrot slock smartmontools system-config-printer transmission-gtk udisks2 ueberzug ufw uget unzip usbutils util-linux vim $REPO_PKGS wget xautolock xcompmgr xdg-desktop-portal-gtk xdg-user-dirs xdg-user-dirs-gtk xdg-utils xf86-input-synaptics xarchiver xcalc xfce4 xfce4-pulseaudio-plugin xfce4-weather-plugin xfce4-whiskermenu-plugin xinit xorg xorg-server xpdf yt-dlp zathura zathura-pdf-poppler"
			SERVICES="$SERVICES cupsd cups-browsed dbus sddm NetworkManager polkitd power-profiles-daemon"
		;;
		*)
...
EOF
	...
	[ "$NIRI" = yes ]    && include_niri
	[ "$PLASMA" = yes ]  && include_plasma
	[ "$PLYMOUTH" = yes ] && include_plymouth
	[ "$POLY" = yes ]    && include_poly
