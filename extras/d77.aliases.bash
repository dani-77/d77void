...
function _set_pkg_aliases() {
	if _command_exists xbps-install; then
		...
		alias muslsig='XBPS_TARGET_ARCH=x86_64-musl xbps-rindex --sign-pkg --privkey privkey.pem hostdir/binpkgs/d77/*.xbps'
		...
		alias muslisobuild='sudo ./musl-d77 -a x86_64-musl -r /home/dani77/d77void-pkgs/hostdir/binpkgs/d77/'
		alias isobuild='sudo ./d77 -r /home/dani77/d77void-pkgs/hostdir/binpkgs/d77/'
		alias hyprbuild='sudo ./d77 -r /home/dani77/d77void-pkgs/hostdir/binpkgs/d77/ -r /home/dani77/hypr-d77/hostdir/binpkgs/'
